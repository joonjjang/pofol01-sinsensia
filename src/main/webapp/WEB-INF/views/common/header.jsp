						...
						<c:choose>
							...
							<c:when test="${isLogOn==true and memberInfo.member_id =='admin'}">
								<div class="d-flex align-items-center gap-2">
									...
									</span> </a> <a href="${contextPath}/admin/goods/adminGoodsMain.do"
										class="text-decoration-none samll btn btn-outline-secondary btn-sm p-0 px-2 rounded-0 bg-white">sinsensia
										관리 </a> <a href="${contextPath}/member/logout.do"
				...
				<div
					...
					<div class="logo d-flex align-items-center px-4">
						<a href="${contextPath}/main/main.do"> <img
							src="${contextPath}/resources/img/sinsensia_logo.png" width="150"
							class="p-2">
						</a>
					</div>
					...
					<c:choose>
						<c:when test="${isLogOn==true and not empty memberInfo }">
							${contextPath}/mypage/listMyOrderHistory.do
						</c:when>
						<c:otherwise>
					...
					" class="mySopang text-decoration-none samll d-flex flex-column px-2 text-center ps-3 mt-2">
						...
						class="my-coupang-title">mypage</span>
					</a> 
